...
@Component({
  selector: 'app-dialog',
  template: `
    <h2 class="mt-8 text-4xl font-extrabold tracking-tight leading-tight">Nota</h2>
    <textarea>{{ data.notaAuto }}</textarea>
    <div>
...
export class DialogComponent {
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) public data: { notaAuto: string }
  ) {}

...
import { PersonaService } from '../dashboards/persona/persona.service';
...
export class DashboardAdminComponent implements OnInit, OnDestroy {
    public get personaService(): PersonaService {
        return this._personaService;
    }
    public set personaService(value: PersonaService) {
        this._personaService = value;
    }
